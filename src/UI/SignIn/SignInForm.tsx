        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-2">
                ...
                <input
                    ...
                    className={`w-full bg-(--bg) border ${signInValueForm.errors.emailOrUsername && signInValueForm.touched?.emailOrUsername
                        ? 'border-red-500'
            ...
            <div className="space-y-2">
                ...
                <input
                    ...
                    className={`w-full bg-(--bg) border ${signInValueForm.errors.password && signInValueForm.touched?.password
                        ? 'border-red-500'
                        : 'border-(--border-header-buttons)'
                        } rounded-md px-3 sm:px-4 py-2.5 sm:py-3 text-(--text-main) placeholder-(--text-secondary) focus:outline-none focus:ring-0 transition-all duration-300 hover:border-(--border-header-buttons-hover) focus:border-(--border-header-buttons-hover) text-sm sm:text-base`}
            ...
            <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-xs sm:text-sm text-blue-400 transition-all duration-300 hover:text-(--text-main)">
                    {t('forgot_password')}
                </a>
            </div>
            ...
            <div className="text-center pt-2">
                <p className="text-xs sm:text-sm text-(--text-secondary)">
                    {t('dont_have_account')} {' '}
                    <a onClick={() => navigate('/signUp')} className="text-blue-400 transition-all duration-300 hover:text-(--text-main) cursor-pointer">
                        {t('create_account')}
                    </a>
                </p>
            </div>
